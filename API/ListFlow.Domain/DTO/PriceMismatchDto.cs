...
{
    public PriceMismatchDto(string itemNumber, string itemTitle, decimal? price, decimal? crossPostPrice,
        string crossPostItemNumber, string SalesChannelId, string crossPostSalesChannelId)
    {
        ...
        CrossPostSalesChannelId = crossPostSalesChannelId;
    }
