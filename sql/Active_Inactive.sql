	Select l.ItemNumber, l.ItemTitle, l.Active,l.dateended, l.datesold, ll.lastupdated, ll.Active, ll.ItemNumber, ll.ItemTitle
...
select  l.ItemNumber, l.ItemTitle, l.Active,l.DateListed, l.dateended, l.datesold
from listflow.Listing l
where active = true
